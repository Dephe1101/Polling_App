  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <h2 className="sm:text-xl font-medium text-slate-800">{title}</h2>
        <button
          className={`flex items-center gap-3 text-sm text-white bg-sky-500 px-4 py-2 ${
      ...
      {open && (
        <div className="flex flex-wrap gap-4 bg-sky-500  p-4 rounded-l-lg rounded-b-lg">
